# -*- coding: utf-8 -*-
"""
Created on Fri Jan 10 13:48:17 2020
...
k2 = 0.5 #Coefficient du cas ii
PAC2 = PileACombustible(M,k2)
B = Batterie(M,12,2*10**(-3),20)

u2 = PAC2.pPAC() #Commande
...
PMP2 = PMP(eps,u2,lbd,t0,tf)
print("lambda* =",PMP2[0],"; u* =",PMP2[1])
print("La fonction coût minimisée vaut",JH2_2(np.array([PMP2[1]]*(len(t)+1))))
