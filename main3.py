# -*- coding: utf-8 -*-
"""
Created on Fri Jan 10 13:48:45 2020
...
k3 = 1 #Coefficient du cas iii
PAC3 = PileACombustible(M,k3)
B = Batterie(M,12,2*10**(-3),20)

u3 = PAC3.pPAC() #Commande
...
PMP3 = PMP(eps,u3,lbd,t0,tf)
print("lambda* =",PMP3[0],"; u* =",PMP3[1])
print("La fonction coût minimisée vaut",JH2_3(np.array([PMP3[1]]*(len(t)+1))))